...
- (void)setupUI {
    ...
    self.greenBall.backgroundColor = [UIColor colorWithRed:35/255.0 green:246/255.0 blue:235/255.0 alpha:1];
    //GKColorRGB(35, 246, 235);
    ...
    self.redBall.backgroundColor = [UIColor colorWithRed:255/255.0 green:46/255.0 blue:86/255.0 alpha:1];
    //GKColorRGB(255, 46, 86);
    ...
    self.blackBall.backgroundColor = [UIColor colorWithRed:12/255.0 green:11/255.0 blue:17/255.0 alpha:1];
    //GKColorRGB(12, 11, 17);
